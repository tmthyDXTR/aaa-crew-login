...
function submitShiftPreferences(request, response) {
    const { viererSchicht, eingangshäuschen, greencamping, nachtwache, küche, künstlerbetreuung, personalbüro, kassenbüro, parkplatz, flaschensammeln, ausschank, schlafenDo, schlafenFr, schlafenSa, frDaAb, frDaBis, saDaAb, saDaBis, soDaAb, soDaBis, userSelect } = request.body;
