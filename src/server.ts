...
{
    response.sendFile(path.join(__dirname, "/../public/scanner.html"));
});

app.get("/booth-ticket-qr-codes", function (request: Request, response: Response)
{
    response.sendFile(path.join(__dirname, "/../public/booth-ticket-qr-codes.html"));
});
...
app.post("/create-booth-ticket", (request: Request, response: Response) => {
...
app.post("/delete-last-booth-ticket", (request: Request, response: Response) => {
...
app.get("/api/guest-list", (request: Request, response: Response) => {
...
app.post("/api/check-in-guest/:id", (request: Request, response: Response) => {
...
app.post("/api/check-out-guest/:id", (request: Request, response: Response) => {
    const { id } = request.params;
